...
class _ChatScreenState extends State<ChatScreen> {
  final StreamController<List<ChatItem>> streamController = StreamController<List<ChatItem>>();
  final Stream<int> stream = Stream<int>.periodic(const Duration(seconds: 5), (count) => count).take(5);
