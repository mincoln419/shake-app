...
final notificationDummies = <TossNotification>[
  ...
  TossNotification(NotificationType.walk, "금일 3000보 달성하셨어요. 앞으로도 화이팅!",
      DateTime.now().subtract(180.minutes)),
  TossNotification(NotificationType.stock, "코스피 2700선 돌파!!!! ",
  ...
  TossNotification(NotificationType.people, "이번 주 공동구매 물픔! 최신형 ☺ 다이슨 헤어 드라이기 ",
      DateTime.now().subtract(21.minutes)),
  TossNotification(NotificationType.tossPay, "이번 달 토스로 받은 혜택 금액을 확인해보세요!",
      DateTime.now().subtract(36.minutes)),
  TossNotification(
      NotificationType.tossPay,
      "경성 크리처 & 토스 페이 콜라보레이션 공개!! 🥰🥰🥰🥰",
      DateTime.now().subtract(443.minutes)),
  TossNotification(NotificationType.walk, "만보기 첼린지 이벤트가 곧 마감됩니다. D-2",
      DateTime.now().subtract(55.minutes)),
  TossNotification(NotificationType.moneyTip, "오늘의 머니팁! 확인해보시겠어요?",
